...
const NotImplementedCommandTypes   = [
    CommandTypes.TodoComments,
    CommandTypes.GetSpanOfEnclosingComment,
    CommandTypes.BraceCompletion,
    CommandTypes.GetSpanOfEnclosingComment,
] as const satisfies readonly CommandTypes[]

const UnmappedTypes = [ // TODO: this should not be a thing
    CommandTypes.Change,
    CommandTypes.Close,
] as const satisfies readonly CommandTypes[]

type ImplementedCommandTypes = Exclude<CommandTypes, typeof NotImplementedCommandTypes[number] | typeof UnmappedTypes[number]>;

interface CommandTypeMap extends Record<ImplementedCommandTypes, [Request, Response]>  {
    [CommandTypes.JsxClosingTag ]: [JsxClosingTagRequest,JsxClosingTagResponse],
    [CommandTypes.LinkedEditingRange ]: [LinkedEditingRangeRequest, LinkedEditingRangeResponse],
    [CommandTypes.Brace ]: [BraceRequest, BraceResponse],
    [CommandTypes.BraceFull ]: [BraceRequest, BraceResponse],
    [CommandTypes.BraceCompletion ]: [BraceCompletionRequest, ],
    // [CommandTypes.Change ]: [ChangeRequest, ],
    // [CommandTypes.Close ]: [CloseRequest, ],
    [CommandTypes.Completions ]: [CompletionsRequest, CompletionsResponse],
    [CommandTypes.CompletionInfo ]: [CompletionsRequest, CompletionInfoResponse ],
    // [CommandTypes.CompletionsFull ]: [ ],
    // [CommandTypes.CompletionDetails ]: [],
    // [CommandTypes.CompletionDetailsFull ]: [],
    // [CommandTypes.CompileOnSaveAffectedFileList ]: [],
    // [CommandTypes.CompileOnSaveEmitFile ]: [],
    [CommandTypes.Configure ]: [ConfigureRequest, ConfigureResponse],
    [CommandTypes.Definition ]: [DefinitionRequest, DefinitionResponse],
    [CommandTypes.DefinitionFull ]: [DefinitionRequest, DefinitionResponse],
    [CommandTypes.DefinitionAndBoundSpan ]: [DefinitionAndBoundSpanRequest, DefinitionAndBoundSpanResponse],
    [CommandTypes.DefinitionAndBoundSpanFull ]: [DefinitionAndBoundSpanRequest, DefinitionAndBoundSpanResponse],
    [CommandTypes.Implementation ]: [ImplementationRequest, ImplementationResponse],
    [CommandTypes.ImplementationFull ]: [ImplementationRequest, ImplementationResponse],
    [CommandTypes.EmitOutput ]: [EmitOutputRequest, EmitOutputResponse],
    // [CommandTypes.Exit ]: [ExitRequest, ],
    [CommandTypes.FileReferences ]: [FileReferencesRequest, FileReferencesResponse],
    [CommandTypes.FileReferencesFull ]: [FileReferencesRequest, FileReferencesResponse],
    [CommandTypes.Format ]: [FormatRequest, FormatResponse],
    // [CommandTypes.Formatonkey ]: [FormatOnKeyRequest, ],
    [CommandTypes.FormatFull ]: [FormatRequest, FormatResponse],
    // [CommandTypes.FormatonkeyFull ]: [FormatOnKeyRequest, ],
    // [CommandTypes.FormatRangeFull ]: [],
    // [CommandTypes.Geterr ]: [GeterrRequest, ],
    // [CommandTypes.GeterrForProject ]: [GeterrForProjectRequest, ],
    [CommandTypes.SemanticDiagnosticsSync ]: [SemanticDiagnosticsSyncRequest, SemanticDiagnosticsSyncResponse],
    [CommandTypes.SyntacticDiagnosticsSync ]: [SyntacticDiagnosticsSyncRequest, SyntacticDiagnosticsSyncResponse],
    [CommandTypes.SuggestionDiagnosticsSync ]: [SuggestionDiagnosticsSyncRequest, SuggestionDiagnosticsSyncResponse],
    [CommandTypes.NavBar ]: [NavBarRequest, NavBarResponse],
    [CommandTypes.NavBarFull ]: [NavBarRequest, NavBarResponse],
    [CommandTypes.Navto ]: [NavtoRequest, NavtoResponse],
    [CommandTypes.NavtoFull ]: [NavtoRequest, NavtoResponse],
    [CommandTypes.NavTree ]: [NavTreeRequest, NavTreeResponse],
    [CommandTypes.NavTreeFull ]: [NavTreeRequest, NavTreeResponse],
    [CommandTypes.DocumentHighlights ]: [DocumentHighlightsRequest, DocumentHighlightsResponse],
    [CommandTypes.DocumentHighlightsFull ]: [DocumentHighlightsRequest, DocumentHighlightsResponse],
    // [CommandTypes.Open ]: [OpenRequest, ],
    [CommandTypes.Quickinfo ]: [QuickInfoRequest, QuickInfoResponse],
    [CommandTypes.QuickinfoFull ]: [QuickInfoRequest, QuickInfoResponse],
    [CommandTypes.References ]: [ReferencesRequest, ReferencesResponse],
    [CommandTypes.ReferencesFull ]: [ReferencesRequest, ReferencesResponse],
    [CommandTypes.Reload ]: [ReloadRequest, ReloadResponse],
    [CommandTypes.Rename ]: [RenameRequest, RenameResponse],
    // [CommandTypes.RenameInfoFull ]: [],
    // [CommandTypes.RenameLocationsFull ]: [],
    // [CommandTypes.Saveto ]: [SavetoRequest, ],
    [CommandTypes.SignatureHelp ]: [SignatureHelpRequest, SignatureHelpResponse],
    [CommandTypes.SignatureHelpFull ]: [SignatureHelpRequest, SignatureHelpResponse],
    // [CommandTypes.FindSourceDefinition ]: [FindSourceDefinitionRequest, ],
    [CommandTypes.Status ]: [StatusRequest, StatusResponse],
    [CommandTypes.TypeDefinition ]: [TypeDefinitionRequest, TypeDefinitionResponse],
    [CommandTypes.ProjectInfo ]: [ProjectInfoRequest, ProjectInfoResponse],
    // [CommandTypes.ReloadProjects ]: [ReloadProjectsRequest, ],
    // [CommandTypes.Unknown ]: [],
    [CommandTypes.OpenExternalProject ]: [OpenExternalProjectRequest, OpenExternalProjectResponse],
    [CommandTypes.OpenExternalProjects ]: [OpenExternalProjectsRequest, OpenExternalProjectsResponse],
    [CommandTypes.CloseExternalProject ]: [CloseExternalProjectRequest, CloseExternalProjectResponse],
    [CommandTypes.SynchronizeProjectList ]: [SynchronizeProjectListRequest, SyntacticDiagnosticsSyncResponse],
    // [CommandTypes.ApplyChangedToOpenFiles ]: [ApplyChangedToOpenFilesRequest, ],
    // [CommandTypes.UpdateOpen ]: [UpdateOpenRequest, ],
    // [CommandTypes.EncodedSyntacticClassificationsFull ]: [ EncodedSyntacticClassificationsRequest, ]
    [CommandTypes.EncodedSemanticClassificationsFull ]: [ EncodedSemanticClassificationsRequest, EncodedSemanticClassificationsResponse],
    // [CommandTypes.Cleanup ]: [ ],
    // [CommandTypes.GetOutliningSpans ]: [ ],
    // [CommandTypes.GetOutliningSpansFull ]: [],
    [CommandTypes.TodoComments ]: [ TodoCommentRequest, TodoCommentRequest],
    [CommandTypes.Indentation ]: [ IndentationRequest, IndentationResponse],
    [CommandTypes.DocCommentTemplate ]: [ DocCommentTemplateRequest, DocCommandTemplateResponse],
    // [CommandTypes.CompilerOptionsDiagnosticsFull ]: [CompilerOptionsDiagnosticsRequest, ],
    // [CommandTypes.NameOrDottedNameSpan ]: [],
    // [CommandTypes.BreakpointStatement ]: [],
    // [CommandTypes.CompilerOptionsForInferredProjects ]: [],
    [CommandTypes.GetCodeFixes ]: [Request, GetCodeFixesResponse],
    // [CommandTypes.GetCodeFixesFull ]: [],
    [CommandTypes.GetCombinedCodeFix ]: [GetCombinedCodeFixRequest, GetCombinedCodeFixResponse],
    [CommandTypes.GetCombinedCodeFixFull ]: [GetCombinedCodeFixRequest, GetCombinedCodeFixResponse],
    [CommandTypes.ApplyCodeActionCommand ]: [ApplyCodeActionCommandRequest, ApplyCodeActionCommandResponse],
    [CommandTypes.GetSupportedCodeFixes ]: [GetSupportedCodeFixesRequest, GetSupportedCodeFixesResponse],
    [CommandTypes.GetApplicableRefactors ]: [GetApplicableRefactorsRequest, GetApplicableRefactorsResponse],
    [CommandTypes.GetEditsForRefactor ]: [GetEditsForRefactorRequest, GetEditsForRefactorResponse],
    // [CommandTypes.GetMoveToRefactoringFileSuggestions ]: [GetMoveToRefactoringFileSuggestionsRequest, ],
    [CommandTypes.GetEditsForRefactorFull ]: [GetEditsForRefactorRequest, GetEditsForRefactorResponse],
    [CommandTypes.OrganizeImports ]: [OrganizeImportsRequest, OrganizeImportsResponse],
    [CommandTypes.OrganizeImportsFull ]: [OrganizeImportsRequest, OrganizeImportsResponse],
    [CommandTypes.GetEditsForFileRename ]: [GetEditsForFileRenameRequest, GetEditsForFileRenameResponse],
    [CommandTypes.GetEditsForFileRenameFull ]: [GetEditsForFileRenameRequest, GetEditsForFileRenameResponse],
    [CommandTypes.ConfigurePlugin ]: [ConfigurePluginRequest, ConfigurePluginResponse],
    [CommandTypes.SelectionRange ]: [SelectionRangeRequest, SelectionRangeResponse],
    [CommandTypes.SelectionRangeFull ]: [SelectionRangeRequest, SelectionRangeResponse],
    // [CommandTypes.ToggleLineComment ]: [ToggleLineCommentRequest, ],
    // [CommandTypes.ToggleLineCommentFull ]: [ToggleLineCommentRequest],
    // [CommandTypes.ToggleMultilineComment ]: [ToggleMultilineCommentRequest, ],
    // [CommandTypes.ToggleMultilineCommentFull ]: [ToggleLineCommentRequest, ],
    // [CommandTypes.CommentSelection ]: [CommentSelectionRequest, ],
    // [CommandTypes.CommentSelectionFull ]: [CommentSelectionRequest, ],
    // [CommandTypes.UncommentSelection ]: [UncommentSelectionRequest, ],
    // [CommandTypes.UncommentSelectionFull ]: [UncommentSelectionRequest],
    [CommandTypes.PrepareCallHierarchy ]: [PrepareCallHierarchyRequest, PrepareCallHierarchyResponse],
    ...
    // [CommandTypes.WatchChange ]: [WatchChangeRequest, ],
}
